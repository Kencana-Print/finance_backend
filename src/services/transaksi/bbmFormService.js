...
// Delphi getnomor BBM: MID(jur_no,3,18) = cno
...
const saveData = async (payload, user) => {
  ...
  // Delphi BBM: TIDAK ada cek cabang di F10 (berbeda dari BKM)
  ...
  try {
    ...
    // Delete jurnal otomatis — BBM pakai MID
    await conn.query(
    ...
    // Insert DEBET header (BBM sama seperti BKM — header pakai jurd_debet)
    await conn.query(
      `
